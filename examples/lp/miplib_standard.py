...
PROBLEM_NAME = "sing2"  # name of MIPLIB problem (without .mps extension)
highs = hspy.Highs()
highs.readModel(
...
def polisher(lr):
    return jo.create_saddle_optimiser(
        ...
        optax.inject_hyperparams(optax.adadelta)(learning_rate=100 * lr),
    )
...
solution, _ = jl.solve(
    ...
    polish_lr_scale_threshold=1e-6,
    polish_merit_threshold=1e-1,
